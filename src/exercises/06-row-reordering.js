...
// EXERCISE:
// Update the `App` component so that the list of cities automatically gets
// sorted by vote count.

// HINT: Be careful for bugs that might result from poor use of `key`!

// HINT: sorting an array can be done using the `.sort(compare)`
// prototype method, with the provided `cityComparator` function
// above.
